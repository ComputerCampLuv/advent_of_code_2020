            ...
            if let Ok(line) = line {
                ...
                match next_data {
                    TicketData::Rules => {
                        ...
                        let lower_a = captures.get(2).unwrap().as_str().to_owned().parse::<usize>().unwrap();
                        let upper_a = captures.get(3).unwrap().as_str().to_owned().parse::<usize>().unwrap();
                        let lower_b = captures.get(4).unwrap().as_str().to_owned().parse::<usize>().unwrap();
                        let upper_b = captures.get(5).unwrap().as_str().to_owned().parse::<usize>().unwrap();
                    ...
                    TicketData::YourTicket => {
                        my_ticket = line.split(",").map(|s| s.parse::<usize>().unwrap()).collect::<Vec<usize>>();
                    },
